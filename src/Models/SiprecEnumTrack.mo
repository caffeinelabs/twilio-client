...
module {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer SiprecEnumTrack type
        public type JSON = Text;

        // Convert User-facing type to JSON-facing Motoko type
        public func toJSON(value : SiprecEnumTrack) : JSON =
            switch (value) {
        ...
        public func fromJSON(json : JSON) : ?SiprecEnumTrack =
            switch (json) {
                case "inbound_track" ?#inbound_track;
                case "outbound_track" ?#outbound_track;
                case "both_tracks" ?#both_tracks;
