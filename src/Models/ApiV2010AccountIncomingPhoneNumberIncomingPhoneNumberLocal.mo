...
import { type IncomingPhoneNumberLocalEnumAddressRequirement; JSON = IncomingPhoneNumberLocalEnumAddressRequirement } "./IncomingPhoneNumberLocalEnumAddressRequirement";

import { type IncomingPhoneNumberLocalEnumEmergencyAddressStatus; JSON = IncomingPhoneNumberLocalEnumEmergencyAddressStatus } "./IncomingPhoneNumberLocalEnumEmergencyAddressStatus";

import { type IncomingPhoneNumberLocalEnumEmergencyStatus; JSON = IncomingPhoneNumberLocalEnumEmergencyStatus } "./IncomingPhoneNumberLocalEnumEmergencyStatus";

import { type IncomingPhoneNumberLocalEnumVoiceReceiveMode; JSON = IncomingPhoneNumberLocalEnumVoiceReceiveMode } "./IncomingPhoneNumberLocalEnumVoiceReceiveMode";

// ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal.mo

module {
    // User-facing type: what application code uses
    public type ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal = {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal type
        public type JSON = {
            account_sid : ?Text;
            address_sid : ?Text;
            address_requirements : ?IncomingPhoneNumberLocalEnumAddressRequirement.JSON;
            api_version : ?Text;
            beta : ?Bool;
            capabilities : ?ApiV2010AccountIncomingPhoneNumberCapabilities;
            date_created : ?Text;
            ...
            trunk_sid : ?Text;
            uri : ?Text;
            voice_receive_mode : ?IncomingPhoneNumberLocalEnumVoiceReceiveMode.JSON;
            voice_application_sid : ?Text;
            voice_caller_id_lookup : ?Bool;
            ...
            voice_url : ?Text;
            emergency_status : ?IncomingPhoneNumberLocalEnumEmergencyStatus.JSON;
            emergency_address_sid : ?Text;
            emergency_address_status : ?IncomingPhoneNumberLocalEnumEmergencyAddressStatus.JSON;
            bundle_sid : ?Text;
            status : ?Text;
        };

        // Convert User-facing type to JSON-facing Motoko type
        public func toJSON(value : ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal) : JSON = { value with
            address_requirements = do ? { IncomingPhoneNumberLocalEnumAddressRequirement.toJSON(value.address_requirements!) };
            ...
            voice_receive_mode = do ? { IncomingPhoneNumberLocalEnumVoiceReceiveMode.toJSON(value.voice_receive_mode!) };
            ...
            emergency_status = do ? { IncomingPhoneNumberLocalEnumEmergencyStatus.toJSON(value.emergency_status!) };
            emergency_address_status = do ? { IncomingPhoneNumberLocalEnumEmergencyAddressStatus.toJSON(value.emergency_address_status!) };
        };

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal {
            ?{ json with
                address_requirements = do ? { IncomingPhoneNumberLocalEnumAddressRequirement.fromJSON(json.address_requirements!)! };
                ...
                voice_receive_mode = do ? { IncomingPhoneNumberLocalEnumVoiceReceiveMode.fromJSON(json.voice_receive_mode!)! };
                ...
                emergency_status = do ? { IncomingPhoneNumberLocalEnumEmergencyStatus.fromJSON(json.emergency_status!)! };
                emergency_address_status = do ? { IncomingPhoneNumberLocalEnumEmergencyAddressStatus.fromJSON(json.emergency_address_status!)! };
            }
        };
    }
}
