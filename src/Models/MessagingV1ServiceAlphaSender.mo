...
// MessagingV1ServiceAlphaSender.mo

module {
    // User-facing type: what application code uses
    public type MessagingV1ServiceAlphaSender = {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer MessagingV1ServiceAlphaSender type
        public type JSON = {
            sid : ?Text;
            account_sid : ?Text;
            service_sid : ?Text;
        ...
        public func toJSON(value : MessagingV1ServiceAlphaSender) : JSON = value;

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?MessagingV1ServiceAlphaSender = ?json;
    }
}
