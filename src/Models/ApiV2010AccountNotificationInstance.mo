...
// ApiV2010AccountNotificationInstance.mo

module {
    // User-facing type: what application code uses
    public type ApiV2010AccountNotificationInstance = {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer ApiV2010AccountNotificationInstance type
        public type JSON = {
            account_sid : ?Text;
            api_version : ?Text;
            call_sid : ?Text;
        ...
        public func toJSON(value : ApiV2010AccountNotificationInstance) : JSON = { value with
            request_method = do ? { ApiV2010AccountCallCallNotificationRequestMethod.toJSON(value.request_method!) };
        };

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?ApiV2010AccountNotificationInstance {
            ?{ json with
