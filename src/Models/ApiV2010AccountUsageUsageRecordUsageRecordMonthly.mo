...
// ApiV2010AccountUsageUsageRecordUsageRecordMonthly.mo

module {
    // User-facing type: what application code uses
    public type ApiV2010AccountUsageUsageRecordUsageRecordMonthly = {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer ApiV2010AccountUsageUsageRecordUsageRecordMonthly type
        public type JSON = {
            account_sid : ?Text;
            api_version : ?Text;
            as_of : ?Text;
        ...
        public func toJSON(value : ApiV2010AccountUsageUsageRecordUsageRecordMonthly) : JSON = value;

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?ApiV2010AccountUsageUsageRecordUsageRecordMonthly = ?json;
    }
}
