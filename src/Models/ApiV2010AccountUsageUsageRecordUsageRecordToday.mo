...
// ApiV2010AccountUsageUsageRecordUsageRecordToday.mo

module {
    // User-facing type: what application code uses
    public type ApiV2010AccountUsageUsageRecordUsageRecordToday = {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer ApiV2010AccountUsageUsageRecordUsageRecordToday type
        public type JSON = {
            account_sid : ?Text;
            api_version : ?Text;
            as_of : ?Text;
        ...
        public func toJSON(value : ApiV2010AccountUsageUsageRecordUsageRecordToday) : JSON = value;

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?ApiV2010AccountUsageUsageRecordUsageRecordToday = ?json;
    }
}
