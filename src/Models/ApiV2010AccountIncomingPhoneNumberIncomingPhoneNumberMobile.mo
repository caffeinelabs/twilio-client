...
import { type IncomingPhoneNumberMobileEnumAddressRequirement; JSON = IncomingPhoneNumberMobileEnumAddressRequirement } "./IncomingPhoneNumberMobileEnumAddressRequirement";

import { type IncomingPhoneNumberMobileEnumEmergencyAddressStatus; JSON = IncomingPhoneNumberMobileEnumEmergencyAddressStatus } "./IncomingPhoneNumberMobileEnumEmergencyAddressStatus";

import { type IncomingPhoneNumberMobileEnumEmergencyStatus; JSON = IncomingPhoneNumberMobileEnumEmergencyStatus } "./IncomingPhoneNumberMobileEnumEmergencyStatus";

import { type IncomingPhoneNumberMobileEnumVoiceReceiveMode; JSON = IncomingPhoneNumberMobileEnumVoiceReceiveMode } "./IncomingPhoneNumberMobileEnumVoiceReceiveMode";

// ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile.mo

module {
    // User-facing type: what application code uses
    public type ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile = {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile type
        public type JSON = {
            account_sid : ?Text;
            address_sid : ?Text;
            address_requirements : ?IncomingPhoneNumberMobileEnumAddressRequirement.JSON;
            api_version : ?Text;
            beta : ?Bool;
            capabilities : ?ApiV2010AccountIncomingPhoneNumberCapabilities;
            date_created : ?Text;
            ...
            trunk_sid : ?Text;
            uri : ?Text;
            voice_receive_mode : ?IncomingPhoneNumberMobileEnumVoiceReceiveMode.JSON;
            voice_application_sid : ?Text;
            voice_caller_id_lookup : ?Bool;
            ...
            voice_url : ?Text;
            emergency_status : ?IncomingPhoneNumberMobileEnumEmergencyStatus.JSON;
            emergency_address_sid : ?Text;
            emergency_address_status : ?IncomingPhoneNumberMobileEnumEmergencyAddressStatus.JSON;
            bundle_sid : ?Text;
            status : ?Text;
        };

        // Convert User-facing type to JSON-facing Motoko type
        public func toJSON(value : ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile) : JSON = { value with
            address_requirements = do ? { IncomingPhoneNumberMobileEnumAddressRequirement.toJSON(value.address_requirements!) };
            ...
            voice_receive_mode = do ? { IncomingPhoneNumberMobileEnumVoiceReceiveMode.toJSON(value.voice_receive_mode!) };
            ...
            emergency_status = do ? { IncomingPhoneNumberMobileEnumEmergencyStatus.toJSON(value.emergency_status!) };
            emergency_address_status = do ? { IncomingPhoneNumberMobileEnumEmergencyAddressStatus.toJSON(value.emergency_address_status!) };
        };

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile {
            ?{ json with
                address_requirements = do ? { IncomingPhoneNumberMobileEnumAddressRequirement.fromJSON(json.address_requirements!)! };
                ...
                voice_receive_mode = do ? { IncomingPhoneNumberMobileEnumVoiceReceiveMode.fromJSON(json.voice_receive_mode!)! };
                ...
                emergency_status = do ? { IncomingPhoneNumberMobileEnumEmergencyStatus.fromJSON(json.emergency_status!)! };
                emergency_address_status = do ? { IncomingPhoneNumberMobileEnumEmergencyAddressStatus.fromJSON(json.emergency_address_status!)! };
            }
        };
    }
}
