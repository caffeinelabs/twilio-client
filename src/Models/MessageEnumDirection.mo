...
module {
    ...
    public type MessageEnumDirection = {
        #inbound;
        #outbound_api;
        #outbound_call;
        #outbound_reply;
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer MessageEnumDirection type
        public type JSON = Text;

        // Convert User-facing type to JSON-facing Motoko type
        public func toJSON(value : MessageEnumDirection) : JSON =
            switch (value) {
        ...
        public func fromJSON(json : JSON) : ?MessageEnumDirection =
            switch (json) {
                case "inbound" ?#inbound;
