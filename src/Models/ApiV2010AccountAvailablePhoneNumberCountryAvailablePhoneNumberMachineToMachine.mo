...
// ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine.mo

module {
    // User-facing type: what application code uses
    public type ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine = {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine type
        public type JSON = {
            friendly_name : ?Text;
            phone_number : ?Text;
            lata : ?Text;
        ...
        public func toJSON(value : ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine) : JSON = value;

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine = ?json;
    }
}
