...
// IncomingPhoneNumberEnumEmergencyAddressStatus.mo
...
module {
    ...
    public type IncomingPhoneNumberEnumEmergencyAddressStatus = {
        #registered;
        #unregistered;
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer IncomingPhoneNumberEnumEmergencyAddressStatus type
        public type JSON = Text;

        // Convert User-facing type to JSON-facing Motoko type
        public func toJSON(value : IncomingPhoneNumberEnumEmergencyAddressStatus) : JSON =
            switch (value) {
        ...
        public func fromJSON(json : JSON) : ?IncomingPhoneNumberEnumEmergencyAddressStatus =
            switch (json) {
                case "registered" ?#registered;
                case "unregistered" ?#unregistered;
