...
// IncomingPhoneNumberMobileEnumEmergencyAddressStatus.mo
...
module {
    ...
    public type IncomingPhoneNumberMobileEnumEmergencyAddressStatus = {
        #registered;
        #unregistered;
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer IncomingPhoneNumberMobileEnumEmergencyAddressStatus type
        public type JSON = Text;

        // Convert User-facing type to JSON-facing Motoko type
        public func toJSON(value : IncomingPhoneNumberMobileEnumEmergencyAddressStatus) : JSON =
            switch (value) {
        ...
        public func fromJSON(json : JSON) : ?IncomingPhoneNumberMobileEnumEmergencyAddressStatus =
            switch (json) {
                case "registered" ?#registered;
                case "unregistered" ?#unregistered;
