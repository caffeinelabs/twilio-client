...
module {
    ...
    public type RecordingEnumSource = {
        #dialverb;
        #conference;
        #outboundapi;
        #trunking;
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer RecordingEnumSource type
        public type JSON = Text;

        // Convert User-facing type to JSON-facing Motoko type
        public func toJSON(value : RecordingEnumSource) : JSON =
            switch (value) {
        ...
        public func fromJSON(json : JSON) : ?RecordingEnumSource =
            switch (json) {
                case "DialVerb" ?#dialverb;
                case "Conference" ?#conference;
                case "OutboundAPI" ?#outboundapi;
