...
// MessagingV1ServiceUsAppToPerson.mo

module {
    // User-facing type: what application code uses
    public type MessagingV1ServiceUsAppToPerson = {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer MessagingV1ServiceUsAppToPerson type
        public type JSON = {
            sid : ?Text;
            account_sid : ?Text;
            brand_registration_sid : ?Text;
        ...
        public func toJSON(value : MessagingV1ServiceUsAppToPerson) : JSON = value;

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?MessagingV1ServiceUsAppToPerson = ?json;
    }
}
