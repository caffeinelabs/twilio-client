...
import { type IncomingPhoneNumberTollFreeEnumAddressRequirement; JSON = IncomingPhoneNumberTollFreeEnumAddressRequirement } "./IncomingPhoneNumberTollFreeEnumAddressRequirement";

import { type IncomingPhoneNumberTollFreeEnumEmergencyAddressStatus; JSON = IncomingPhoneNumberTollFreeEnumEmergencyAddressStatus } "./IncomingPhoneNumberTollFreeEnumEmergencyAddressStatus";

import { type IncomingPhoneNumberTollFreeEnumEmergencyStatus; JSON = IncomingPhoneNumberTollFreeEnumEmergencyStatus } "./IncomingPhoneNumberTollFreeEnumEmergencyStatus";

import { type IncomingPhoneNumberTollFreeEnumVoiceReceiveMode; JSON = IncomingPhoneNumberTollFreeEnumVoiceReceiveMode } "./IncomingPhoneNumberTollFreeEnumVoiceReceiveMode";

// ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree.mo

module {
    // User-facing type: what application code uses
    public type ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree = {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree type
        public type JSON = {
            account_sid : ?Text;
            address_sid : ?Text;
            address_requirements : ?IncomingPhoneNumberTollFreeEnumAddressRequirement.JSON;
            api_version : ?Text;
            beta : ?Bool;
            capabilities : ?ApiV2010AccountIncomingPhoneNumberCapabilities;
            date_created : ?Text;
            ...
            trunk_sid : ?Text;
            uri : ?Text;
            voice_receive_mode : ?IncomingPhoneNumberTollFreeEnumVoiceReceiveMode.JSON;
            voice_application_sid : ?Text;
            voice_caller_id_lookup : ?Bool;
            ...
            voice_url : ?Text;
            emergency_status : ?IncomingPhoneNumberTollFreeEnumEmergencyStatus.JSON;
            emergency_address_sid : ?Text;
            emergency_address_status : ?IncomingPhoneNumberTollFreeEnumEmergencyAddressStatus.JSON;
            bundle_sid : ?Text;
            status : ?Text;
        };

        // Convert User-facing type to JSON-facing Motoko type
        public func toJSON(value : ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree) : JSON = { value with
            address_requirements = do ? { IncomingPhoneNumberTollFreeEnumAddressRequirement.toJSON(value.address_requirements!) };
            ...
            voice_receive_mode = do ? { IncomingPhoneNumberTollFreeEnumVoiceReceiveMode.toJSON(value.voice_receive_mode!) };
            ...
            emergency_status = do ? { IncomingPhoneNumberTollFreeEnumEmergencyStatus.toJSON(value.emergency_status!) };
            emergency_address_status = do ? { IncomingPhoneNumberTollFreeEnumEmergencyAddressStatus.toJSON(value.emergency_address_status!) };
        };

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?ApiV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree {
            ?{ json with
                address_requirements = do ? { IncomingPhoneNumberTollFreeEnumAddressRequirement.fromJSON(json.address_requirements!)! };
                ...
                voice_receive_mode = do ? { IncomingPhoneNumberTollFreeEnumVoiceReceiveMode.fromJSON(json.voice_receive_mode!)! };
                ...
                emergency_status = do ? { IncomingPhoneNumberTollFreeEnumEmergencyStatus.fromJSON(json.emergency_status!)! };
                emergency_address_status = do ? { IncomingPhoneNumberTollFreeEnumEmergencyAddressStatus.fromJSON(json.emergency_address_status!)! };
            }
        };
    }
}
