...
// IncomingPhoneNumberTollFreeEnumEmergencyAddressStatus.mo
...
module {
    ...
    public type IncomingPhoneNumberTollFreeEnumEmergencyAddressStatus = {
        #registered;
        #unregistered;
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer IncomingPhoneNumberTollFreeEnumEmergencyAddressStatus type
        public type JSON = Text;

        // Convert User-facing type to JSON-facing Motoko type
        public func toJSON(value : IncomingPhoneNumberTollFreeEnumEmergencyAddressStatus) : JSON =
            switch (value) {
        ...
        public func fromJSON(json : JSON) : ?IncomingPhoneNumberTollFreeEnumEmergencyAddressStatus =
            switch (json) {
                case "registered" ?#registered;
                case "unregistered" ?#unregistered;
